...
public class Utils {
    ...
    public static final String CATEGORIES_URL = "http://www.adaldosso.com/quantospendi/srv/categorie.php";
    public static final String ADD_EXPENSE_URL = "http://www.adaldosso.com/quantospendi/srv/spesa-add.php";
